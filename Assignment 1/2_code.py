...
#distance between object and camera (in pixel)
z = 60*38
...
x_im_points = []
y_im_points = []
print("The two (x,y) image points for the length of cuboid are : ")
...
print("Length of cuboid from image points: ",math.dist([x_im_points[0],y_im_points[0]], [x_im_points[1],y_im_points[1]]))
...
#Euclidian distance (length of cuboid) from world points
print("Length of cuboid from world points: ",math.dist([x_w_points[0],y_w_points[0]], [x_w_points[1],y_w_points[1]]))